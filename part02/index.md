...
The examples explored here largely use the DublinCore standard [@dcmiterms], since it is not only lightweight but is also an openly documented standard that has been widely used to describe digital cultural heritage content.
